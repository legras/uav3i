...
/**
 * Classe instanciée côté serveur dans le cas d'une communication RMI :<br/>
 ...
 */
public class PaparazziTransmitterRMIImpl implements IPaparazziTransmitter
{
  //-----------------------------------------------------------------------------
  ...
  private static PaparazziTransmitterRMIImpl instance;
  //-----------------------------------------------------------------------------
  private PaparazziTransmitterRMIImpl() throws IvyException, RemoteException
  {
    super();
    initializeIvy();
    //UAVModel.initialize();
  ...
  //-----------------------------------------------------------------------------
  public static PaparazziTransmitterRMIImpl getInstance() throws RemoteException, IvyException
  {
    if(instance == null)
      instance = new PaparazziTransmitterRMIImpl();
    return instance;
  }
  //-----------------------------------------------------------------------------
  @Override
