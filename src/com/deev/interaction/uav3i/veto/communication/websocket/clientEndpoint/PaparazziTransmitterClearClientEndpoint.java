...
@ClientEndpoint()
public class PaparazziTransmitterClearClientEndpoint
{
  //-----------------------------------------------------------------------------
  private Session session = null;
  //-----------------------------------------------------------------------------
  public PaparazziTransmitterClearClientEndpoint(URI uriServerEndpoint) throws DeploymentException, IOException
  {
