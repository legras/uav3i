...
@ServerEndpoint(value="/Uav3iTransmitterAddCamStatus")
public class Uav3iTransmitterAddCamStatusServerEndPoint
{
  //-----------------------------------------------------------------------------
  ...
  {
    Uav3iTransmitterAddCamStatusServerEndPoint.session = session;
  }
  //-----------------------------------------------------------------------------
  public static void addCamStatus(String message) throws IOException
  {
    if(session.isOpen())
